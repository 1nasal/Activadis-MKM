<x-app-layout>
    ...
    <div class="py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-4xl mx-auto">
            ...
            <div class="bg-white overflow-visible shadow sm:rounded-lg">
                <div class="p-6 space-y-6">
                    ...
                    <form method="POST" action="{{ route('users.update', $user->id) }}" id="editUserForm">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="hidden" id="job_title" name="job_title" value="{{ old('job_title', $user->job_title) }}">
                            ...
                            <div class="relative" id="jobTitleDropdown">
                                ...
                                <div id="jobTitleMenu"
                                     class="absolute z-[3000] hidden mt-1 w-full bg-white/95 backdrop-blur border border-gray-200 rounded-lg shadow-2xl">
                                    ...
                                    <ul id="jobTitleList" class="max-h-64 overflow-auto py-1"></ul>
                        ...
                        <div class="mb-4 relative">
                            <div class="flex items-center">
                                ...
                                <label for="is_admin" class="ml-2 text-sm font-medium text-gray-900 cursor-pointer">
    ...
    {{-- Dropdown script (Add / Edit / Delete, full-row select + checkbox) --}}
    <script>
    (function() {
        ...
        function selectTitle(name) {
            ...
            closeMenu(); // remove this line if you want the menu to stay open
        }
        ...
        // Close on outside press early so underlying controls get the click
