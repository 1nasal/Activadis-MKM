                ...
                <form method="POST" action="{{ route('activities.update', $activity) }}">
                    ...
                    <div class="mb-4">
                        ...
                        <select class="w-full border rounded p-2" name="includes_food" id="includes_food" required>
                            <option value="1" {{ old('includes_food', $activity->includes_food) == '1' ? 'selected' : '' }}>Yes</option>
                            <option value="0" {{ old('includes_food', $activity->includes_food) == '0' ? 'selected' : '' }}>No</option>
                        </select>
