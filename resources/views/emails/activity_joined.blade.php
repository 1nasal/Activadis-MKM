    ...
    <tr>
        <td align="center">
            <table width="600" cellpadding="0" cellspacing="0" border="0"
                ...
                <tr>
                    <td style="background-color:#FFD60A; padding:20px; text-align:center;">
                        <h1 style="margin:0; font-size:24px; color:#333;">Bevestiging deelname</h1>
                    </td>
                </tr>
                ...
                <tr>
                    <td style="padding:30px; color:#333;">
                        ...
                        <p style="font-size:16px; line-height:1.5;">
                            ...
                            @if($activity->end_time) tot {{ $activity->end_time->format('H:i') }} @endif
                        </p>
                ...
                <tr>
                    <td style="background-color:#fafafa; padding:15px; text-align:center; font-size:12px; color:#777;">
                        &copy; {{ date('Y') }} Jouw Organisatie. Alle rechten voorbehouden.
                    </td>
                </tr>
            </table>
        </td>
